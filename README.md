...
- `Olheiro_0.3.1_x64-setup.exe`: recommended installer for Windows.
- `Olheiro_0.3.1_x64_en-US.msi`: alternative MSI installer.
...
- `src-tauri\target\release\bundle\nsis\Olheiro_0.3.1_x64-setup.exe`
- `src-tauri\target\release\bundle\msi\Olheiro_0.3.1_x64_en-US.msi`
